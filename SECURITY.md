...
To report a vulnerability, please [create an issue](https://github.com/pnp/powerfx-samples/issues/new/choose) and tag the issue as `vulnerability-suspected`.
...
<img src="https://telemetry.sharepointpnp.com/powerfx-samples/SECURITY.md" />